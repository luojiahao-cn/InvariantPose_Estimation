     ...
     'p_ours', [], 'R_ours', [], 'p_Rlm', [], 'R_Rlm', [],...
      'lm_pos_error', [], 'lm_rot_error', [],...
       'elm_pos_error', [], 'elm_rot_error', [], ... 
         'ours_pos_error', [], 'ours_rot_error', [], 'ours_err_displacement', [],...
...
function summary = calculate_point_summary(results)
    ...
    ours_err_displacement = [results.ours_err_displacement];
    ...
    summary.ours.err_displacement_mean = mean(ours_err_displacement);
    summary.ours.err_displacement_std = std(ours_err_displacement);
